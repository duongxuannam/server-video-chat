"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.guid = guid;exports.makeMemberCode = makeMemberCode;exports.removePhonePrefix = removePhonePrefix;exports.isMobilePhone = isMobilePhone;exports.insertPhonePrefix = insertPhonePrefix;exports.changeAlias = changeAlias;exports.customGenerationFunction = exports.queryPhone = void 0; // Generate password
function guid() {
  function s4() {
...
function removePhonePrefix(phoneNumber) {
...
function insertPhonePrefix(prefix, phoneNumber) {
  let _result = phoneNumber;
  if (phoneNumber) {
...
(Math.random().toString(36) + '00000000000').substring(2, 16);exports.customGenerationFunction = customGenerationFunction;