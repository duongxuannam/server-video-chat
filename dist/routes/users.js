...
var _user = _interopRequireDefault(require("../models/user"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
routes.get('/', async (req, res) => {
  try {
    const userInstance = new _user.default({
